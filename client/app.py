...
# 1) lit BACKEND_URL depuis l'env (Azure App Service) ou st.secrets
BACKEND_URL = (
    os.getenv("BACKEND_URL")
    or st.secrets.get("BACKEND_URL", None)   # optionnel si tu utilises secrets
    or "http://backend:8000"                 # défaut pour docker-compose local
)

# 2) construit l’endpoint /predict
